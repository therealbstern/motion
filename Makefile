...
# install.                                                                     #
################################################################################
CFLAGS       =  -g -O2 -D_REENTRANT -I/usr/include/SDL -D_GNU_SOURCE=1 -D_REENTRANT -I/usr/include/mysql -I/usr/include -DMOTION_V4L2 -DMOTION_V4L2_OLD -DTYPE_32BIT="int" -DHAVE_BSWAP   -march=i686 -Wall -DVERSION=\"Git-8619d7c17ce112e7196975905c6e840f345141ba\" -Dsysconfdir=\"$(sysconfdir)\" 
LDFLAGS      =  
LIBS         = -lm  -lpthread -L/usr/lib -Wl,-rpath,/usr/lib -lSDL -lpthread -ljpeg -lsqlite3 -L/usr/lib -lmysqlclient -lz -L/usr/lib -lpq 
...
################################################################################
pre-build-info: 
	@echo "Welcome to the setup procedure for Motion, the motion detection daemon! If you"
	@echo "get error messages during this procedure, please report them to the mailing"
	@echo "list. The Motion Guide contains all information you should need to get Motion up"
	@echo "and running. Run \"make updateguide\" to download the latest version of the"
	@echo "Motion Guide."
	@echo
